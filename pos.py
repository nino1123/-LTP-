...
Input = open("..\\LTP\\ltp_data_v3.4.0\\ceshi.txt", "r")
Result = open("..\\LTP\\posoutput.txt", "w+")
...
def work():
    ...
    cws_model_path = "..\\LTP\\ltp_data_v3.4.0\cws.model"
    pos_model_path = "..\\LTP\\ltp_data_v3.4.0\pos.model"
    ...
    recognizer.load('..\\LTP\\ltp_data_v3.4.0\\ner.model')
